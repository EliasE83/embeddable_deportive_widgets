...
class ApiService {
  ...
  static String get calendarHost {
    final raw = apiUrl.trim();
    final host = raw.replaceFirst(RegExp(r'^https?://', caseSensitive: false), '');
    return host.replaceFirst(RegExp(r'^api\.', caseSensitive: false), 'stats.');
  }

  static String buildSeasonICalUrl({
    String? season,
    ...
    final qp = <String, String>{
      ...
      'league': leagueId,
      if (teamId != null && teamId.isNotEmpty && teamId != 'all') 'team': teamId,
    };
    return Uri(
      scheme: 'https',
      host: calendarHost,
  ...
  static String buildGameICalUrl(String gameId) {
    return Uri(
      scheme: 'https',
      host: calendarHost,
      path: 'team-cal.php',
      queryParameters: {'format': 'iCal', 'game_id': gameId},
    ).toString();
  }
